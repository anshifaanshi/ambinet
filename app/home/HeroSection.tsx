    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      >
        <div className="h-full flex flex-col">
          {/* Close Button */}
          <div className="flex justify-start p-8 bg-white">
            <button
              onClick={() => setIsMenuOpen(false)}
              className="flex items-center justify-center w-12 h-12 bg-[#1e3a5f] hover:bg-[#2a4d7f] transition-colors text-white"
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          {/* Footer Links */}
          <div className="flex justify-center gap-8 py-8 bg-gray-100 text-[#1e3a5f] text-xs tracking-[0.2em] uppercase font-medium">
        ...
        <div className="absolute left-0 top-1/2 -translate-y-1/2 flex flex-col items-center gap-6 bg-white/80 py-6 px-3">
          ...
          <div className="w-px h-20 bg-[#1e3a5f]/30"></div>
          <span 
            className="text-[#1e3a5f] text-xs tracking-[0.3em] font-bold"
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <nav className="flex items-center justify-between px-8 py-6">
          ...
          >
            <div className="flex items-center justify-center w-12 h-12 bg-orange-500 hover:bg-orange-600 transition-colors">
              <MenuIcon />
            </div>
            <span className="text-sm font-medium tracking-wider uppercase">MENU</span>
          </button>

          <div className="text-white text-3xl font-bold tracking-[0.3em]">
            AMBIENT
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
              ...
              className="px-6 py-2 bg-orange-500 text-white text-xs tracking-[0.2em] uppercase font-medium hover:bg-orange-600 transition-all duration-300"
              style={{ 
                fontFamily: 'sans-serif',
                letterSpacing: '0.15em'
              }}
        ...
        <div className="flex-1 flex items-center px-8 md:px-16 lg:px-24">
          <div className="max-w-4xl">
            <h1 
              className={`text-white text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold mb-8 leading-[1.1] transition-all duration-1000 ${
            ...
            <button 
              className={`px-10 py-4 bg-orange-500 text-white text-xs tracking-[0.2em] uppercase font-medium hover:bg-orange-600 transition-all duration-300 rounded ${
                isTransitioning ? 'opacity-0 translate-y-8' : 'opacity-100 translate-y-0'
              }`}
              style={{ 
